 ...
 * indipendente dalle altre. La torre rimane in vita finché i minion
 * non la portano a 0 punti vita.
 *
 *  ITA_MAX = 4800 – punti vita totali 
 *  ATTACCO   = 160  – danno inflitto ad ogni tiro su un minion
 *  INTERVALLO_ATTACCO = 1500 ms – cadenza di fuoco
 *
 * Il metodo {@link #subisciDanno(double)} è {@code synchronized} per evitare
 * race condition quando più thread minion attaccano contemporaneamente la stessa torre.
 * Il campo {@code vita} è {@code volatile} per garantire la visibilità aggiornata
 * tra thread diversi senza sincronizzazione esplicita nelle sole letture.
 */
public class Torre {
    ...
    /**
     * Punti vita correnti della torre.
     * Dichiarato {@code volatile} affinché le letture da thread diversi
     * (es. il loop di aggiornamento della progress-bar) vedano sempre il valore più recente.
     */
    ...
    /**
     * Applica il danno ricevuto dai minion, riducendo i punti vita.
     * La vita non scende mai sotto zero.
     *
     * Metodo {@code synchronized} per gestire attacchi simultanei
     * da più thread {@link MinionThreads}.
     *
