 ...
 * prioritario presente nell'ondata, ma solo se quel minion ha raggiunto la
 * soglia di avvicinamento ({@link #SOGLIA_ATTACCO} = 85/100 della corsia). Se
 * nessun minion è entro soglia, il ciclo prosegue senza infliggere danni.
 *
 * Ordine di priorità dei bersagli: SOLDATO → MAGO → CANNONE → CAMPIONE
 *
...
public class TorreThreads implements Runnable {
    ...
    /**
     * Soglia di posizione (0–100) oltre la quale la torre apre il fuoco. Un
     * minion deve aver percorso almeno l'85% della corsia per essere
     * attaccabile.
     */
    public static final int SOGLIA_ATTACCO = 85;

    /**
     * Ordine con cui la torre sceglie il bersaglio. Viene scandito dall'indice
     * 0 al 3; viene attaccato il primo minion vivo del tipo con la priorità più
     * alta che è entro {@link #SOGLIA_ATTACCO}.
     */
    ...
    /**
     * Loop principale: ogni {@link Torre#INTERVALLO_ATTACCO} ms cerca il
     * bersaglio più prioritario e, se trovato entro soglia, gli infligge
     * {@link Torre#ATTACCO} danni.
     */
    @Override
    public void run() {
    ...
    /**
     * Scansiona la lista dei minion seguendo {@link #PRIORITA} e restituisce il
     * primo bersaglio valido: vivo + tipo corrispondente + posizione ≥
     * {@link #SOGLIA_ATTACCO}.
     *
